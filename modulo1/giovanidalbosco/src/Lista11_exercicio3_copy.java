...
public class Lista11_exercicio3_copy {
    public static void main(String[] args) {
        ...
        int tamanhoVetorDiferenca = vetor1.length - contador2;
...
/*81) Faça um programa que carregue dois vetores, X e Y, com dez números inteiros cada um. Considere que os números 
de cada vetor digital, X e Y, não podem estar repetidos. Calcule e mostre os seguintes vetores resultantes:
